            ...
            <div class="card-body">
                ...
                <form method="POST" type="hidden" action="{{ route('socios.update', $socio) }}" class="form-signin" enctype="multipart/form-data">
                    ...
                    <div class="form-label-group">
                        <input id="foto_url" type="file" class="form-control{{ $errors->has('foto_url') ? ' is-invalid' : '' }}" name="foto_url" accept="image/*" value="{{$socio->foto_url}}" optional="optional">
                    ...
                    <div class="form-label-group">
                        <input type="text" class="form-control" name="name" id="name" placeholder="Nome completo" autofocus="autofocus" pattern="/^[\pL\s]+$/u" title="Nome completo deve conter apenas letras" value="{{ old('name', $socio->name) }}">
                    ...
                    <div class="form-label-group">
                        <input type="text" class="form-control" name="nome_informal" id="nome_informal" placeholder="Nome informal" pattern="/^[\pL\s]+$/u" title="Nome informal deve conter apenas letras" value="{{ old('nome_informal', $socio->nome_informal) }}">
                    ...
                    <div class="form-label-group">
                        <input type="text" class="form-control" name="data_nascimento" id="data_nascimento" placeholder="Data nascimento" pattern="^\d{1,2}\-\d{1,2}\-\d{4}$" title="Data nascimento deve estar formatada corretamente" value="{{ old('data_nascimento', $socio->data_nascimento) }}">
                    ...
                    <div class="form-label-group">
                        <input type="text" class="form-control" name="email" id="email" placeholder="Email" pattern="^\w+@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$" title="Email deve estar formatado corretamente" value="{{ old('email', $socio->email) }}" required>
                    ...
                    <div class="form-label-group">
                        <input type="text" class="form-control" name="nif" id="nif" placeholder="Nif" pattern="^[0-9]+$" title="NIF deve conter apenas numeros" value="{{ old('nif', $socio->nif) }}">
                    ...
                    <div class="form-label-group">
                        <input type="text" class="form-control" name="telefone" id="telefone" placeholder="Telefone" pattern="^[+]*[(]{0,1}[0-9]{1,4}[)]{0,1}[-\s\./0-9]*$" title="Numero de telefone deve conter apenas numeros" value="{{ old('telefone', $socio->telefone) }}">
                    ...
                    <div class="form-label-group">
                        <input type="text" class="form-control" name="endereco" id="endereco" placeholder="Endereco" value="{{ old('endereco', $socio->endereco) }}">
