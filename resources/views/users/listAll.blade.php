    ...
    <div class="card card-signin my-14">
        <div class="card-body">
            ...
            <form class="col-md-auto" method="GET" action="{{route('socios.index')}}">
                ...
                Número sócio:<br>
                <input id="num_socio" type="text" class="form-control{{ $errors->has('num_socio') ? ' is-invalid' : '' }}" name="num_socio" value="{{ old('num_socio') }}" autofocus="autofocus">
                Nome informal:<br>
                <input id="nome_informal" type="text" class="form-control{{ $errors->has('nome_informal') ? ' is-invalid' : '' }}" name="nome_informal" value="{{ old('nome_informal') }}" autofocus="autofocus">
                E-mail:<br>
                <input id="email" type="text" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" autofocus="autofocus">
                <br>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">
                                            ...
                                            <a href="{{route('socios.edit', $socio->id)}}">
                                                <button type="submit" class="btn btn-block btn-success text-uppercase" name="ok">Editar
                                                </button>
                                            </a>
