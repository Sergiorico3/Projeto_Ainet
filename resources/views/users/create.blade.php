            ...
            <div class="card">
                ...
                <form method="POST" action="{{route('socios.store')}}" type="hidden" name="store" class="form-group" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12 col-md-4">
                        ...
                        <input type="text" class="form-control" name="name" id="name" placeholder="Introduza o nome completo" required pattern="^[a-zA-ZÀ-ú\s]+$" title="Nome completo deve conter apenas letras" />
                        <br>
                    </div>

                    <div class="col-sm-12 col-md-4">
                        <label for="num_socio">Número de sócio</label>
                        <input type="text" class="form-control" name="num_socio" id="num_socio" placeholder="Introduza o nome informal" required pattern="^[0-9]+$" title="Número de sócio deve de conter apenas numeros" />
                        <br>
                    </div>

                    <div class="col-sm-12 col-md-4">
                        <label for="nome_informal">Nome informal</label>
                        <input type="text" class="form-control" name="nome_informal" id="nome_informal" placeholder="Introduza o nome informal" required pattern="^[a-zA-ZÀ-ú\s]+$" title="Nome informal deve conter apenas letras" />
                        <br>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-4">
                        ...
                        <input type="email" class="form-control" name="email" id="inputEmail" placeholder="Endereço de e-mail" pattern="^\w+@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$" required title="Email must be properly formatted" />
                        <br>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-4">
                        ...
                        <input type="number" class="form-control" name="nif" id="nif" placeholder="NIF" pattern="^[0-9]+$" title="O NIF deve conter apenas números" />
                        <br>
                    </div>

                    <div class="col-sm-12 col-md-4">
                        <label for="telefone">Telefone</label>
                        <input type="number" class="form-control" name="telefone" id="telefone" placeholder="Telefone" pattern="^[0-9]+$" title="O telefone deve conter apenas números" />
                        <br>
                    </div>
