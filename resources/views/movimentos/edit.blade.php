            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('movimentos.update', $movimento)}}" class="form-signin" enctype="multipart/form-data">
                    ...
                    <div class="form-label-group">
                        ...
                        <input name="data" type="date" class="form-control" id="inputData" placeholder="Data do voo" autofocus="autofocus" pattern="^\d{4}\-\d{1,2}\-\d{1,2}$" title="Data do voo deve ter o formato correto (exemplo: 2013-11-24)" value="{{ old('data', $movimento->data) }}" required>
                    ...
                    <div class="form-label-group">
                        <input type="time" class="form-control" name="hora_descolagem" id="inputHora_descolagem" placeholder="Hora de descolagem" autofocus="autofocus" pattern="^(0[0-9]|1[0-9]|2[0-3]|[0-9]):[0-5][0-9]$" title="Deve introduzir uma hora de descolagem válida (exemplo: 2013-11-24 08:45:00)" value="{{ old('hora_descolagem', $movimento->hora_descolagem) }}">
                    ...
                    <div class="form-label-group">
                        <input type="time" class="form-control" name="hora_aterragem" id="inputHora_aterragem" placeholder="Hora de aterragem" autofocus="autofocus" pattern="^\d{4}\-\d{1,2}\-\d{1,2}$\ \d{1,2}\:\d{1,2}\:d{1,2}$" title="Deve introduzir uma hora de aterragem válida (exemplo: 2013-11-24 08:45:00) " value="{{ old('hora_aterragem', $movimento->hora_aterragem) }}">
                    ...
                    <div class="form-label-group">
                        <input type="text" class="form-control" name="num_diario" id="inputNum_diario" placeholder="num_diario" autofocus="autofocus" pattern="^[0-9]+$" title="N.º diário deve conter apenas números" value="{{ old('num_diario', $movimento->num_diario) }}">
                    ...
                    <div class="form-label-group">
                        <input type="text" class="form-control" name="num_servico" id="inputNum_servico" placeholder="num_servico" autofocus="autofocus" pattern="^[0-9]+$" title="N.º serviço deve conter apenas números" value="{{ old('num_servico', $movimento->num_servico) }}">
                    ...
                    <div class="form-label-group">
                        <input type="text" class="form-control" name="num_aterragens" id="inputNum_aterragens" placeholder="num_aterragens" autofocus="autofocus" pattern="^[0-9]+$" title="N.º de aterragens deve conter apenas números" value="{{ old('num_aterragens', $movimento->num_aterragens) }}">
                    ...
                    <div class="form-label-group">
                        <input type="text" class="form-control" name="num_descolagens" id="inputNum_descolagens" placeholder="num_descolagens" autofocus="autofocus" pattern="^[0-9]+$" title="N.º de descolagens deve conter apenas números" value="{{ old('num_descolagens', $movimento->num_descolagens) }}">
                    ...
                    <div class="form-label-group">
                        <input type="text" class="form-control" name="num_pessoas" id="inputNum_pessoas" placeholder="num_pessoas" autofocus="autofocus" pattern="^[0-9]+$" title="N.º de pessoas deve conter apenas números" value="{{ old('num_pessoas', $movimento->num_pessoas) }}">
                    ...
                    <div class="form-label-group">
                        <input type="text" class="form-control" name="conta_horas_inicio" id="inputConta_horas_inicio" placeholder="conta_horas_inicio" autofocus="autofocus" pattern="^[0-9]+$" title="Conta-horas início deve conter apenas números" value="{{ old('conta_horas_inicio', $movimento->conta_horas_inicio) }}">
                    ...
                    <div class="form-label-group">
                        <input type="text" class="form-control" name="conta_horas_fim" id="inputConta_horas_fim" placeholder="conta_horas_fim" autofocus="autofocus" pattern="^[0-9]+$" title="Conta-horas fim deve conter apenas números" value="{{ old('conta_horas_fim', $movimento->conta_horas_fim) }}">
                    ...
                    <div class="form-label-group">
                        <input type="text" class="form-control" name="tempo_voo" id="inputTempo_voo" placeholder="tempo_voo" autofocus="autofocus" pattern="^[0-9]+$" title="Tempo do voo deve conter apenas números" value="{{ old('tempo_voo', $movimento->tempo_voo) }}">
                    ...
                    <div class="form-label-group">
                        <input type="text" class="form-control" name="preco_voo" id="inputPreco_voo" placeholder="preco_voo" autofocus="autofocus" pattern="^\d*\.?\d*$" title="Preço do voo deve conter apenas números" value="{{ old('preco_voo', $movimento->preco_voo) }}">
                    ...
                    <div class="form-label-group">
                        <input type="text" class="form-control" name="num_recibo" id="inputNum_recibo" placeholder="num_recibo" autofocus="autofocus" pattern="^[0-9]+$" title="N.º do recibo deve conter apenas números" value="{{ old('num_recibo', $movimento->num_recibo) }}">
                    ...
                    <div class="form-label-group">
                        <textarea class="form-control" name="observacoes" id="inputObservacoes" placeholder="observacoes" autofocus="autofocus">{{ old('observacoes', $movimento->observacoes) }}</textarea>
